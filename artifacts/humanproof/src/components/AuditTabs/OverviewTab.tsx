      ...
      <div className="space-y-2">
        {actions.map((a, i) => (
          <motion.div key={i} initial={{ opacity: 0, x: -6 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.5 + i * 0.08 }}
            className="flex items-start gap-3 p-3 rounded-xl bg-[var(--alpha-bg-05)] border border-[var(--alpha-bg-05)] hover:bg-[var(--alpha-bg-10)] transition-colors">
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="w-full text-left p-3 flex items-start gap-3 hover:bg-[var(--alpha-bg-04)] transition-colors"
              >
      ...
      <div className="px-4 py-3">
          ...
          {top3.map((lever: any, idx: number) => {
            ...
            return (
              <div key={lever.dimension} className="rounded-lg border border-[var(--alpha-bg-06)] p-2.5 bg-[var(--alpha-bg-01)]">
                ...
                {/* Impact bar */}
                <div className="h-1 bg-[var(--alpha-bg-05)] rounded-full overflow-hidden mb-2">
        ...
        <div className="mt-3 pt-3 border-t border-[var(--alpha-bg-05)] grid grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 gap-2">
          {[
            ...
            <div key={item.label} className="text-center rounded-lg bg-[var(--alpha-bg-02)] border border-[var(--alpha-bg-05)] p-2">
      ...
      <div className="px-4 pt-3 pb-2">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-3">
          {[
            ...
            <div key={i} className="rounded-lg bg-[var(--alpha-bg-04)] border border-[var(--alpha-bg-06)] p-2.5 text-center">
              ...
              {/* Mini progress bar */}
              <div className="mt-2 h-1 rounded-full bg-[var(--alpha-bg-08)] overflow-hidden">
                <motion.div
                  initial={{ width: 0 }}
        ...
        <div className="flex flex-wrap gap-2 text-[10px]">
          <span className="px-2 py-1 rounded bg-[var(--alpha-bg-04)] border border-[var(--alpha-bg-07)]">
        ...
        {expanded && (
          <div className="mt-3 space-y-3">
            {report.contradictions.map((c: any, i: number) => {
              ...
              return (
                <div key={i} className="rounded-lg border border-[var(--alpha-bg-07)] p-3 bg-[var(--alpha-bg-02)]">
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-3 pb-2">
          ...
          {resilience.pillars.map((p: any, i: number) => {
            ...
            return (
              <div key={i} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-1.5 rounded-full bg-[var(--alpha-bg-08)] overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
        ...
        {/* Key insight row */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-2">
          <div className="rounded-lg bg-[var(--alpha-bg-02)] border border-[var(--alpha-bg-05)] p-2">
        ...
        {expanded && (
          <div className="mt-3 space-y-1.5">
            ...
            {resilience.resilienceImprovementPlan.map((action: string, i: number) => (
              <div key={i} className="flex gap-2 items-start text-[10px] text-muted-foreground leading-snug p-2 rounded-lg bg-[var(--alpha-bg-02)] border border-[var(--alpha-bg-05)]">
  ...
  return (
    ...
    >
      ...
      <div className="px-4 pt-3 pb-2">
        ...
        {expanded && (
          <div className="mt-3 p-3 rounded-lg border border-[var(--alpha-bg-07)] bg-[var(--alpha-bg-02)]">
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={() => setExpanded(e => !e)}
        className="w-full flex items-center justify-between px-4 py-2.5 border-t border-[var(--alpha-bg-06)] hover:bg-[var(--alpha-bg-02)] transition-colors"
      >
        ...
        <div className="px-4 pb-4 space-y-2 pt-2">
          {runway.optimalSequence.map((step: any) => {
            const priorityColor = step.priority === 'must_do' ? 'var(--red)'
              ...
              : 'var(--text-3)';
            return (
              <div key={step.step} className="flex gap-2.5 items-start rounded-lg border border-[var(--alpha-bg-06)] p-2.5 bg-[var(--alpha-bg-01)]">
                <div className="flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-black mt-0.5"
    ...
    <section aria-labelledby="overview-heading" className="space-y-6">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
        ...
        {scoreIsUnreliable ? (
          ...
          <div className="mt-6 rounded-xl border border-[var(--alpha-bg-12)] bg-[var(--alpha-bg-04)] p-6 text-center">
        ...
        <div className="mt-4 rounded-xl border border-[var(--alpha-bg-10)] bg-[var(--alpha-bg-04)] p-4">
          ...
          {/* Percentile bar */}
          <div className="relative h-3 bg-[var(--alpha-bg-05)] rounded-full overflow-hidden mb-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {methodologyOpen && (
                <div
                  ...
                  role="note"
                  className="mt-2 mb-2 rounded-lg border border-[var(--alpha-bg-10)] bg-[var(--alpha-bg-04)] p-3 text-[11px] leading-relaxed text-muted-foreground"
                >
        ...
        <div className="mt-6 pt-6 border-t border-[var(--alpha-bg-05)]">
          ...
          {feedbackSent ? (
            ...
            <div className="flex gap-3">
              <button onClick={() => handleFeedback('correct')} className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[var(--alpha-bg-10)] bg-[var(--alpha-bg-05)] hover:bg-emerald-500/10 hover:border-emerald-500/30 transition-colors text-xs font-semibold">
                <ThumbsUp className="w-3.5 h-3.5" /> Yes, accurate
              </button>
              <button onClick={() => handleFeedback('incorrect')} className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[var(--alpha-bg-10)] bg-[var(--alpha-bg-05)] hover:bg-red-500/10 hover:border-red-500/30 transition-colors text-xs font-semibold">
