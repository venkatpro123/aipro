...
const DAY_CONTENT_BY_URGENCY_ROLE: Record<ExecutionUrgency, Record<RoleFamily | 'default', DailyPriority[]>> = {
  ...
  elevated: {
    ...
    // ── v50.0: filled elevated-mode content for all major role families ──────
    fin: [
      { day: 1, focus: 'Market rate research — your most powerful negotiation anchor', primaryAction: 'Spend 1 hour on Glassdoor + LinkedIn Salary + Wall Street Oasis + AmbitionBox to document P25/P50/P75 compensation for your specific finance role at your seniority and metro. This single session changes every subsequent conversation you will have.', primaryDuration: '1 hour', endOfDayCheck: 'Market rate benchmarks for your role + seniority + metro. You know your number.' },
      { day: 2, focus: 'LinkedIn finance profile optimisation', primaryAction: 'Rewrite headline: "[Role] | [Years] yr [Finance specialty] | [Credential: CFA/CA/CPA]". Add quantified deal or model descriptions to current role: "Owned DCF models for [X] transactions" or "Managed [Y] FP&A cycle supporting [Z] BU."', primaryDuration: '2 hours', endOfDayCheck: 'LinkedIn headline updated with credential + 3 quantified finance achievements.' },
      { day: 4, focus: 'Finance-specialist headhunter registration', primaryAction: 'Register with Selby Jennings, Michael Baker International, or Robert Half Finance — 60% of senior finance roles never appear on job boards. Email CV with deal/model tombstones or anonymised modelling samples.', primaryDuration: '1 hour', endOfDayCheck: '2 specialist finance recruiter registrations submitted.' },
      { day: 7, focus: 'Target company identification by financial stability', primaryAction: 'Build a list of 8 target companies with improving or stable financials that are NOT in your sector contagion wave. Prioritise profitable FinTechs and well-capitalised enterprises over declining revenue legacy BFSI.', primaryDuration: '1 hour', endOfDayCheck: '8 financially stable targets identified with rationale documented.' },
    ],
    mkt: [
      { day: 1, focus: 'Marketing portfolio — your proof of performance is your primary differentiator', primaryAction: 'Build a 1-page marketing portfolio: 3 campaigns with channel, budget, and outcomes (CAC, ROAS, MQLs, pipeline created). CMOs evaluate candidates on measurable results, not job titles. This is your competitive asset.', primaryDuration: '2 hours', endOfDayCheck: 'Marketing portfolio PDF or Notion page ready with 3 quantified campaign outcomes.' },
      { day: 2, focus: 'Specialisation positioning — specialists get 3× more relevant recruiter contacts', primaryAction: 'Rewrite LinkedIn headline to reflect your 2 specific marketing specialisations: "B2B Demand Gen + ABM" / "Performance Marketing + CRO" / "Brand + Influencer". Choose the 2 that match what your target companies are hiring for.', primaryDuration: '1 hour', endOfDayCheck: 'LinkedIn headline reflects your 2 specific marketing specialisations.' },
      { day: 4, focus: 'Growth-stage company identification via funding signals', primaryAction: 'Find 8 companies that raised Series B/C in the last 12 months in your industry using Crunchbase or LinkedIn. Post-funding companies are in aggressive hiring mode and need growth marketing leadership urgently.', primaryDuration: '1 hour', endOfDayCheck: '8 recently funded growth-stage companies identified with marketing team signals confirmed.' },
      { day: 7, focus: 'Warm outreach to marketing leadership', primaryAction: 'Connect with 5 CMOs or marketing directors at target companies. Lead your message with a specific marketing insight relevant to their industry — not a job request. These conversations convert to referrals in 3–4 weeks.', primaryDuration: '1 hour', endOfDayCheck: '5 warm marketing leader connections sent with specific content observations.' },
    ],
    ops: [
      { day: 1, focus: 'Operational impact documentation — your numbers are your interview answers', primaryAction: 'Write 3 operational improvement statements: "Reduced COGS by [X]% through [method]" / "Cut order-to-delivery cycle by [Y] days" / "Managed team of [N] across [scope]". These ARE your interview answers at any ops company.', primaryDuration: '1.5 hours', endOfDayCheck: '3 quantified operational impact statements written and ready for resume + interview.' },
      { day: 2, focus: 'GCC operations targeting — pays 30–45% more than equivalent Indian company ops roles', primaryAction: 'Research GCC operations roles at JPMorgan GCC, Walmart Global Tech, EXL Service, Concentrix, and WNS. These companies pay significantly above market for the same skills. Check their careers pages for supply chain, operations, or process excellence roles.', primaryDuration: '1 hour', endOfDayCheck: '5 GCC operations targets with open role verification.' },
      { day: 4, focus: 'Professional association network activation', primaryAction: 'Message 5 contacts from APICS, ISM, Lean/Six Sigma, or ASCM certification communities. 60% of mid-senior ops roles are filled through professional networks — this is not optional, it is the primary channel.', primaryDuration: '1 hour', endOfDayCheck: '5 professional association network messages sent.' },
      { day: 7, focus: 'Certification currency and next investment', primaryAction: 'Verify CSCP, CPIM, PMP, or Lean/Six Sigma certifications are current and listed with certification number on LinkedIn. Then research which emerging certification (supply chain analytics, digital logistics, EV operations) appears most in target job postings.', primaryDuration: '45 min', endOfDayCheck: 'Certifications current. Next upskilling investment identified.' },
    ],
    cons: [
      { day: 1, focus: 'Alumni network — the primary channel for consulting exits, not job boards', primaryAction: 'Message 5 former colleagues who have exited to industry or boutique firms. Not a job request — ask about their transition experience. This intelligence changes how you frame your search and is worth more than 50 cold applications.', primaryDuration: '1 hour', endOfDayCheck: '5 alumni messages sent.' },
      { day: 2, focus: 'Exit narrative — what industry hiring managers actually want to hear', primaryAction: 'Prepare your "exit narrative": what problem you want to OWN (not advise on), in which sector, and why now. Hiring managers are 3× more likely to interview consultants who have a clear ownership ambition vs. "I want to try industry."', primaryDuration: '1.5 hours', endOfDayCheck: 'Clear 60-second exit narrative written, practiced aloud, and ready to deliver.' },
      { day: 4, focus: 'PE-backed portfolio company targeting', primaryAction: 'Identify 5 PE-backed portfolio companies in your sector specialty. These hire from consulting at 2× the rate of public companies and value strategic frameworks. Check Bain Capital, Sequoia, KKR, and Advent portfolio pages for your sector.', primaryDuration: '1 hour', endOfDayCheck: '5 PE-backed portfolio companies identified with management team hiring confirmation.' },
      { day: 7, focus: 'Specialty positioning across all channels', primaryAction: 'Update LinkedIn, firm alumni network, and practice-group profiles to emphasise your sector depth (FinTech strategy / supply chain transformation / healthcare operations). Generalist consultants are fungible; specialists get premium rates and faster placement.', primaryDuration: '1 hour', endOfDayCheck: 'Sector specialisation consistent across LinkedIn, alumni portal, and case framing.' },
    ],
    ds: [
      { day: 1, focus: 'Portfolio refresh — GitHub + Kaggle are your discoverable professional identity in data science', primaryAction: 'Ensure GitHub has 2 pinned projects with business framing: "Churn model reduced CAC by [X]%" not "Logistic regression tutorial". DS hiring managers search GitHub. This is where you are discovered.', primaryDuration: '2 hours', endOfDayCheck: '2 GitHub projects with business-framing README files pinned and public.' },
      { day: 2, focus: 'Market benchmark — data science salaries are higher than most candidates realise', primaryAction: 'Research market rates on Levels.fyi, AmbitionBox, Kaggle Salary Survey, and Analytics Vidhya Jobs. DS shortage is real — you likely have more market leverage than you are currently using. Know your P50 before any conversation.', primaryDuration: '1 hour', endOfDayCheck: 'Market rate benchmarks for your DS specialty and seniority level documented.' },
      { day: 4, focus: 'Analytics consulting firm pipeline — always hiring, faster process than product companies', primaryAction: 'Apply to Tiger Analytics, Fractal Analytics, Mu Sigma, Sigmoid, and LatentView. Analytics consulting firms hire aggressively year-round. They are the highest-volume DS employer in India and have 3–5 week hiring timelines vs. 8–12 weeks at product companies.', primaryDuration: '2 hours', endOfDayCheck: '3 analytics consulting applications submitted.' },
      { day: 7, focus: 'Single differentiation angle — specialists convert applications to interviews at 3× rate', primaryAction: 'Choose ONE specialisation: production ML (MLOps, model serving) OR domain expertise (FinTech risk, healthcare, e-commerce). Make this the lead message on LinkedIn and all applications. The market cannot value "DS generalist" — but it can pay a premium for your specific depth.', primaryDuration: '1 hour', endOfDayCheck: 'Single differentiation angle identified and reflected in LinkedIn headline.' },
    ],
    pm: [
      { day: 1, focus: 'Product portfolio — this is what replaces the resume in PM hiring', primaryAction: 'Create a product portfolio document: for each major product you owned, write 3 bullets: (1) Problem statement, (2) Key decision and why, (3) Outcome metric. 2–3 products is the right depth. This distinguishes you from 80% of applicants with identical resumes.', primaryDuration: '2.5 hours', endOfDayCheck: 'Product portfolio with 2–3 products ready to share as PDF or Notion link.' },
      { day: 2, focus: 'AI PM positioning — pays 30–50% more and is severely undersupplied', primaryAction: 'Update LinkedIn skills and summary to explicitly include "AI Product Management" if you have any relevant experience (AI features, LLM integration, ML-powered products). This label alone generates 40% more recruiter outreach in 2025.', primaryDuration: '1 hour', endOfDayCheck: 'LinkedIn reflects AI PM experience or adjacent AI product involvement.' },
      { day: 4, focus: 'PM community outreach — 30% of PM roles at growth-stage companies fill through communities', primaryAction: 'Post a product lesson or framework in 2 PM communities: Product School India Slack, PM Fellowship, or the Circles.life PM community. Inbound from these communities arrives with 50% less competition than LinkedIn applications.', primaryDuration: '1 hour', endOfDayCheck: '2 PM community posts or discussions initiated.' },
      { day: 7, focus: 'Target company PM interview format research', primaryAction: 'Research the specific PM interview format at your top 3 targets (product design vs. product sense vs. analytical vs. technical) — each company tests differently. Read the last 10 Glassdoor/Blind PM interview experiences for each company.', primaryDuration: '1.5 hours', endOfDayCheck: 'PM interview format and common questions documented for top 3 targets.' },
    ],
    bpo: [
      { day: 1, focus: 'Analytics-led CX reframing — your headline determines your salary range', primaryAction: 'Rewrite LinkedIn headline from "Customer Service / Team Lead" to "[CX Analytics / Process Excellence Lead] | [Volume or accuracy metric] | [Tool: Salesforce/NICE/Genesys]". This shifts you from the BPO commodity market to the higher-paying analytics-led CX market.', primaryDuration: '1 hour', endOfDayCheck: 'LinkedIn headline rewritten with analytics and process excellence framing.' },
      { day: 2, focus: 'Healthcare revenue cycle opportunity assessment', primaryAction: 'Research Omega Healthcare, GeBBS Healthcare, Firstsource Solutions, and nThrive. If you have any medical process exposure (claims, billing, RCM), these roles pay 25–40% more than equivalent general BPO. Determine if your current skills map here.', primaryDuration: '1 hour', endOfDayCheck: 'Healthcare BPO opportunity assessment complete.' },
      { day: 4, focus: 'RPA certification path evaluation', primaryAction: 'Evaluate UiPath Foundation (2–4 weeks, free) or Automation Anywhere Essentials. BPO professionals with automation certifications earn 40–50% more. The BPO professionals who thrive through automation disruption are the ones who automate the work, not the ones being automated.', primaryDuration: '45 min', endOfDayCheck: 'RPA certification decision made. If yes: registered and scheduled.' },
      { day: 7, focus: 'Growth-oriented BPO target identification', primaryAction: 'Identify 6 BPO companies that are growing rather than contracting: analytics-led, healthcare-focused, or next-gen CX platforms. Avoid companies in pure automation transformation — they are eliminating your current role profile.', primaryDuration: '1 hour', endOfDayCheck: '6 growth-oriented BPO targets identified, 3 automation-risk companies excluded from list.' },
    ],
    ind: [
      { day: 1, focus: 'EV sector targeting — the fastest-growing industrial market in India', primaryAction: 'Research Ola Electric, Tata EV, Ather Energy, Mahindra Electric, Hero Electric careers pages for your specific function. EV manufacturing is urgently scaling and industrial talent is the structural bottleneck — their hiring pipelines are often thin.', primaryDuration: '1 hour', endOfDayCheck: '5 EV company targets with specific open roles identified.' },
      { day: 2, focus: 'Certification currency and PLI beneficiary targeting', primaryAction: 'Verify all certifications (AutoCAD version, PLC type, ASME/ISO standards) are current on LinkedIn with version numbers. Then identify PLI scheme beneficiaries in your sector (electronics, pharma, auto) — they are expanding capacity and are often undersearched by industrial talent.', primaryDuration: '1 hour', endOfDayCheck: 'Certifications current. 3 PLI beneficiary companies identified.' },
      { day: 4, focus: 'Manufacturing specialist recruiter engagement', primaryAction: 'Register with CIEL HR Manufacturing, ABC Consultants Engineering, or Talentiser. 60% of mid-senior industrial roles are filled through specialist recruiters — the visible openings on Naukri/LinkedIn are the minority.', primaryDuration: '1 hour', endOfDayCheck: '2 specialist manufacturing recruiter registrations submitted.' },
      { day: 7, focus: 'Warm network activation through industry associations', primaryAction: 'Message 3 contacts from CII, FICCI, NASSCOM Manufacturing, or your professional certification community. Industrial roles are heavily community-driven at mid-senior levels.', primaryDuration: '45 min', endOfDayCheck: '3 industry association messages sent.' },
    ],
    legal: [
      { day: 1, focus: 'In-house legal targeting — pays 30–50% more than equivalent firm roles', primaryAction: 'Research in-house legal counsel roles at FinTech/tech companies in your city. Companies like Razorpay, PhonePe, Freshworks post legal roles internally or through recruiters before job boards. Direct outreach to head of legal is more effective than portals.', primaryDuration: '1 hour', endOfDayCheck: '5 in-house legal targets identified with company legal team sizes researched.' },
      { day: 2, focus: 'Legal specialist recruiter registration', primaryAction: 'Register with Mancer Consulting Legal, Michael Page Legal, or ABC Consultants Legal. In-house legal roles are 70% placed through specialist recruiters — general job boards have < 20% of actual openings.', primaryDuration: '1 hour', endOfDayCheck: '2 legal specialist recruiter registrations submitted.' },
      { day: 4, focus: 'Practice specialisation positioning', primaryAction: 'Identify your 1–2 practice area specialisations (data privacy / FinTech regulation / IP / M&A). Update LinkedIn, Martindale, and CV to lead with these. Specialist legal profiles receive 5× more relevant calls vs. generalist "corporate lawyer" positioning.', primaryDuration: '1 hour', endOfDayCheck: 'Legal specialisation consistently positioned across all professional profiles.' },
      { day: 7, focus: 'Alumni and bar network activation', primaryAction: 'Message 3 law school alumni or bar association contacts who have made in-house transitions. Ask about their experience — intelligence gathering, not job seeking. In legal culture this is completely expected, respected, and effective.', primaryDuration: '45 min', endOfDayCheck: '3 alumni or bar contacts messaged.' },
    ],
    design: [
      { day: 1, focus: 'Portfolio update — your work is the only thing that gets you interviews in design', primaryAction: 'Update Behance, Dribbble, or personal site with 2–3 case studies. Each needs: Problem + Process + Decision + Outcome metric. Portfolios without outcomes are read as junior-level regardless of experience.', primaryDuration: '3 hours', endOfDayCheck: '2 portfolio case studies with outcome metrics live and shareable.' },
      { day: 2, focus: 'AI design tools signal — currently generates 40% more recruiter contacts', primaryAction: 'Update LinkedIn skills with generative AI design tools you use: Midjourney, Adobe Firefly, Galileo AI, Figma AI. The market is in a fast transition — designers who signal AI fluency are receiving premiums, those who don\'t are being filtered out at the screen stage.', primaryDuration: '45 min', endOfDayCheck: 'AI design tool proficiencies updated on LinkedIn.' },
      { day: 4, focus: 'Target company research by design maturity signal', primaryAction: 'Identify 6 companies known for design investment (CRED, Swiggy, Razorpay, PhonePe, Freshworks, Zerodha) + 2 companies growing fast but underinvesting in design. The latter are the most eager to upgrade their design function and the most willing to hire at your level.', primaryDuration: '1 hour', endOfDayCheck: '6 design-forward + 2 design-upgrade-opportunity targets identified.' },
      { day: 7, focus: 'Warm outreach to design leadership with specific creative observations', primaryAction: 'Connect with 3 design directors or heads of design at target companies. Include a specific design observation about their product ("I noticed the X flow on your app has Y friction — curious if that\'s intentional"). This demonstrates design thinking instantly in a way no resume can.', primaryDuration: '1.5 hours', endOfDayCheck: '3 design leader connections with specific product observations in message.' },
    ],
    // Remaining stubs
    hr: [], sales: [], edu: [], gov: [],
  },
  standard: {
    ...
    sw: [
      { day: 1, focus: 'Annual market rate check — your compensation baseline intelligence', primaryAction: 'Check Levels.fyi, Glassdoor, and LinkedIn Salary for your exact tech stack + seniority + metro. Engineering salaries drift significantly. Knowing your P50 gives you leverage at current role AND clarity about whether to stay.', primaryDuration: '1 hour', endOfDayCheck: 'Market rate benchmarks for your stack + seniority + metro documented.' },
      { day: 7, focus: 'One meaningful technical portfolio contribution', primaryAction: 'Ship one public contribution: a GitHub project, a technical blog post, or a meaningful open-source commit. Engineers with active public contributions receive 2× more inbound recruiter contacts than those without.', primaryDuration: '2 hours', endOfDayCheck: 'One public technical contribution completed and shareable.' },
    ],
    fin: [
      { day: 1, focus: 'Annual compensation benchmark', primaryAction: 'Research your market rate using Glassdoor, AmbitionBox, and LinkedIn Salary for your finance specialty. Finance salary data is volatile — check at least annually. Your benchmark changes every subsequent conversation.', primaryDuration: '1 hour', endOfDayCheck: 'Market rate documented for your finance specialty and seniority.' },
    ],
    hc: [
      { day: 1, focus: 'Clinical market rate check and Doximity profile review', primaryAction: 'Check MGMA, Medscape, or Doximity Compensation Report for your specialty. Then update your Doximity profile — the professional network most clinical hiring managers actively use.', primaryDuration: '1 hour', endOfDayCheck: 'Market rate documented. Doximity profile updated.' },
    ],
    mkt: [
      { day: 1, focus: 'Marketing performance benchmark', primaryAction: 'Research marketing compensation at your specialty level using LinkedIn Salary and industry-specific surveys (Mumbrella, Marketing Week). Then document your top 3 campaign metrics from the last 12 months — build the portfolio while it\'s fresh.', primaryDuration: '1.5 hours', endOfDayCheck: 'Market rate known. 3 campaign metrics documented for portfolio.' },
    ],
    ds: [], pm: [], hr: [], sales: [], legal: [], ops: [], design: [], ind: [], edu: [], gov: [], bpo: [], cons: [],
  },
  monitoring: {
    default: [
