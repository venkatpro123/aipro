...
export function ImprovementList({ improvements, unit = 'pts' }: { improvements: ImprovementAction[]; unit?: string }) {
  return (
    <div>
      <div style={{ fontSize: 9, fontWeight: 800, color: '#10b981', letterSpacing: '0.1em', marginBottom: 8 }}>WHAT TO DO (RANKED BY IMPACT)</div>
      ...
      <div style={{ marginTop: 12, fontSize: 10, color: 'rgba(255,255,255,0.25)', lineHeight: 1.5 }}>
        Impact estimates are modeled from your audit signals — directional, not guaranteed. They sharpen as you log real outcomes.
      </div>
    </div>
  );
}
