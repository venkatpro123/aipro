// NY8: Korea Deep — 20 companies (2026 real data)
import pg from 'pg';
const { Pool } = pg;
const pool = new Pool({ connectionString: process.env.DATABASE_URL, ssl: { rejectUnauthorized: false } });
const UA = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36';
const FX = { USD:1, KRW:1/1335, JPY:1/150, EUR:1.08 };
...
const companies = [
  { canonical_name:'samsung electronics', display_name:'Samsung Electronics Co., Ltd.', country_code:'KR', is_public:true, ticker:'SSNLF', exchange:'OTC',
    sector:'Technology', industry:'Consumer Electronics',
    // Samsung cut ~500 in DS division 2024; overall stable
    workforce_count:267000, workforce_source:'annual_report_fy2024', workforce_confidence:0.92,
    ...
    hiring_velocity_score:0.5, total_open_roles:5000, hiring_source:'corporate_careers_page', hiring_confidence:0.85 },

  { canonical_name:'lg electronics', display_name:'LG Electronics Inc.', country_code:'KR', is_public:true, ticker:'LGELY', exchange:'OTC',
    sector:'Technology', industry:'Consumer Electronics',
    workforce_count:73000, workforce_source:'annual_report_fy2024', workforce_confidence:0.90,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.4, total_open_roles:1500, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'hyundai motor', display_name:'Hyundai Motor Company', country_code:'KR', is_public:true, ticker:'HYMTF', exchange:'OTC',
    sector:'Consumer Discretionary', industry:'Automobile Manufacturers',
    workforce_count:75000, workforce_source:'annual_report_fy2024', workforce_confidence:0.90,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.5, total_open_roles:2000, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'kia corporation', display_name:'Kia Corporation', country_code:'KR', is_public:true, ticker:'KIMTF', exchange:'OTC',
    sector:'Consumer Discretionary', industry:'Automobile Manufacturers',
    workforce_count:52000, workforce_source:'annual_report_fy2024', workforce_confidence:0.90,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.4, total_open_roles:1500, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'posco holdings', display_name:'POSCO Holdings Inc.', country_code:'KR', is_public:true, ticker:'PKX', exchange:'NYSE',
    sector:'Materials', industry:'Steel',
    workforce_count:18000, workforce_source:'annual_report_fy2024', workforce_confidence:0.90,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.3, total_open_roles:500, hiring_source:'corporate_careers_page', hiring_confidence:0.80 },

  { canonical_name:'kb financial group', display_name:'KB Financial Group Inc.', country_code:'KR', is_public:true, ticker:'KB', exchange:'NYSE',
    ...
    hiring_velocity_score:0.3, total_open_roles:500, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'shinhan financial group', display_name:'Shinhan Financial Group Co., Ltd.', country_code:'KR', is_public:true, ticker:'SHG', exchange:'NYSE',
    sector:'Financials', industry:'Banking',
    workforce_count:22000, workforce_source:'annual_report_fy2024', workforce_confidence:0.90,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.90,
    hiring_velocity_score:0.3, total_open_roles:400, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'celltrion', display_name:'Celltrion, Inc.', country_code:'KR', is_public:true, ticker:'CLLXF', exchange:'OTC',
    sector:'Healthcare', industry:'Drug Manufacturers',
    workforce_count:4500, workforce_source:'annual_report_fy2024', workforce_confidence:0.88,
  ...
  { canonical_name:'kt&g corporation', display_name:'KT&G Corporation', country_code:'KR', is_public:true, ticker:'KTGGY', exchange:'OTC',
    sector:'Consumer Staples', industry:'Tobacco',
    workforce_count:5000, workforce_source:'annual_report_fy2024', workforce_confidence:0.88,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.2, total_open_roles:100, hiring_source:'corporate_careers_page', hiring_confidence:0.78 },

  { canonical_name:'krafton', display_name:'KRAFTON, Inc.', country_code:'KR', is_public:true, ticker:'KFRGF', exchange:'OTC',
  ...
  { canonical_name:'samsung biologics', display_name:'Samsung Biologics Co., Ltd.', country_code:'KR', is_public:true, ticker:'SMBGF', exchange:'OTC',
    sector:'Healthcare', industry:'Drug Manufacturers',
    workforce_count:6500, workforce_source:'annual_report_fy2024', workforce_confidence:0.88,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.88,
    hiring_velocity_score:0.8, total_open_roles:400, hiring_source:'corporate_careers_page', hiring_confidence:0.82 },

  { canonical_name:'samsung ct', display_name:'Samsung C&T Corporation', country_code:'KR', is_public:true, ticker:'SSUMY', exchange:'OTC',
    sector:'Industrials', industry:'Engineering & Construction',
    workforce_count:17000, workforce_source:'annual_report_fy2024', workforce_confidence:0.88,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.85,
    hiring_velocity_score:0.3, total_open_roles:400, hiring_source:'corporate_careers_page', hiring_confidence:0.78 },

  { canonical_name:'sk innovation', display_name:'SK Innovation Co., Ltd.', country_code:'KR', is_public:true, ticker:'SKOFF', exchange:'OTC',
  ...
  { canonical_name:'hanwha aerospace', display_name:'Hanwha Aerospace Co., Ltd.', country_code:'KR', is_public:true, ticker:'HWACF', exchange:'OTC',
  ...
  { canonical_name:'hd hyundai', display_name:'HD Hyundai Co., Ltd.', country_code:'KR', is_public:true, ticker:'HDDVF', exchange:'OTC',
  ...
  { canonical_name:'ncsoft', display_name:'NCsoft Corporation', country_code:'KR', is_public:true, ticker:'NCSCF', exchange:'OTC',
    sector:'Communication Services', industry:'Electronic Gaming & Multimedia',
    // NCsoft cut ~800 (10%) in 2024 amid game portfolio restructuring
    workforce_count:7000, workforce_source:'annual_report_fy2024', workforce_confidence:0.88,
    recent_layoff_count:1, largest_layoff_pct:10.0, layoff_last_event_at:'2024-06-30T00:00:00Z', layoff_source:'news_reports_2024', layoff_confidence:0.88,
    hiring_velocity_score:-0.4, total_open_roles:150, hiring_source:'corporate_careers_page', hiring_confidence:0.75 },

  { canonical_name:'lotte shopping', display_name:'Lotte Shopping Co., Ltd.', country_code:'KR', is_public:true, ticker:'LOTRY', exchange:'OTC',
  ...
  { canonical_name:'doosan bobcat', display_name:'Doosan Bobcat Inc.', country_code:'KR', is_public:true, ticker:'DOOBF', exchange:'OTC',
    sector:'Industrials', industry:'Farm & Heavy Construction Machinery',
    workforce_count:9000, workforce_source:'annual_report_fy2024', workforce_confidence:0.85,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.82,
    hiring_velocity_score:0.3, total_open_roles:200, hiring_source:'corporate_careers_page', hiring_confidence:0.75 },

  { canonical_name:'kakaobank', display_name:'Kakao Bank Corp.', country_code:'KR', is_public:true, ticker:'KAOBF', exchange:'OTC',
    sector:'Financials', industry:'Banking',
    workforce_count:2200, workforce_source:'annual_report_fy2024', workforce_confidence:0.85,
    recent_layoff_count:0, largest_layoff_pct:null, layoff_last_event_at:null, layoff_source:'public_records', layoff_confidence:0.82,
    hiring_velocity_score:0.5, total_open_roles:100, hiring_source:'corporate_careers_page', hiring_confidence:0.78 },

  { canonical_name:'netmarble', display_name:'Netmarble Corporation', country_code:'KR', is_public:true, ticker:'NTMBF', exchange:'OTC',
    sector:'Communication Services', industry:'Electronic Gaming & Multimedia',
    // Netmarble cut ~2500 in 2023-2024 amid mobile game market decline
    workforce_count:6000, workforce_source:'annual_report_fy2024', workforce_confidence:0.85,
    recent_layoff_count:1, largest_layoff_pct:28.0, layoff_last_event_at:'2024-03-31T00:00:00Z', layoff_source:'news_reports_2023_2024', layoff_confidence:0.88,
    hiring_velocity_score:-0.5, total_open_roles:100, hiring_source:'corporate_careers_page', hiring_confidence:0.72 },
];

async function run() {
  const client = await pool.connect();
  console.log('\n✓ Connected — NY8: Korea Deep (2026 data)\n');
  ...
  for (const co of companies) {
    ...
    const params=[co.canonical_name,co.display_name,co.country_code,co.is_public,co.ticker,co.exchange,co.sector,co.industry,
      ...
      stockPrice,marketCapUsd,peRatio,revenueTtm,change90d,finSrc,finConf,'verified','ny8-v2026.1'];
  ...
  console.log(`\n✅ NY8 complete — ${ins} inserted, ${upd} updated`);
