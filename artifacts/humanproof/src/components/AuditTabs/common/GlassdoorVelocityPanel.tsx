...
const TIER_CONFIG: Record<Exclude<CEOApprovalRiskTier, 'UNKNOWN'>, { color: string; bg: string; border: string; label: string }> = {
  CRITICAL: { color: '#ef4444', bg: 'rgba(239,68,68,0.09)',   border: 'rgba(239,68,68,0.24)',   label: 'CRITICAL'  },
  ...
  LOW:      { color: '#10b981', bg: 'rgba(16,185,129,0.06)', border: 'rgba(16,185,129,0.18)',  label: 'LOW'       },
};
