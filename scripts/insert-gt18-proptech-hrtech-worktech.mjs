// GT18: PropTech, HRTech & WorkTech (2026)
import pg from 'pg';
const { Pool } = pg;
...
async function upsertCompany(c) {
  ...
  const vals = [
    ...
    c.data_quality_tier??(c.is_public?'verified':'seed'), c.enrichment_version??'gt18-v2026.1', now
  ];
...
const companies = [
  // ── HRTech / WorkTech (Yahoo-listed) ──────────────────────────────────────
  { canonical_name:'workday inc', display_name:'Workday Inc.', ticker:'WDAY', exchange:'NASDAQ',
    industry:'HR Information Systems / ERP / Financial Management / Workforce Planning SaaS', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:19000, workforce_source:'annual_report', workforce_confidence:0.90,
    ...
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'hubspot inc', display_name:'HubSpot Inc.', ticker:'HUBS', exchange:'NYSE',
    industry:'CRM / Marketing Automation / Sales Hub / Service Hub / Content Hub / SMB SaaS', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:7700, workforce_source:'annual_report', workforce_confidence:0.90,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.80,
    hiring_velocity_score:0.3, total_open_roles:350, hiring_source:'linkedin_scrape', hiring_confidence:0.75,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'freshworks inc', display_name:'Freshworks Inc.', ticker:'FRSH', exchange:'NASDAQ',
    industry:'CRM / Customer Support / IT Service Management / Freshdesk / Freshservice', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:4500, workforce_source:'annual_report', workforce_confidence:0.88,
    recent_layoff_count:2, layoff_source:'news_rss_scrape', layoff_confidence:0.85,
    hiring_velocity_score:-0.4, total_open_roles:200, hiring_source:'linkedin_scrape', hiring_confidence:0.72,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'korn ferry', display_name:'Korn Ferry', ticker:'KFY', exchange:'NYSE',
    industry:'Executive Search / Organizational Consulting / HR Advisory / Leadership Development', sector:'Technology',
  ...
  { canonical_name:'asgn incorporated', display_name:'ASGN Incorporated', ticker:'ASGN', exchange:'NYSE',
    industry:'IT Staffing / Technology Consulting / Professional Services / Federal IT Staffing', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:32000, workforce_source:'annual_report', workforce_confidence:0.88,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.78,
    hiring_velocity_score:-0.3, total_open_roles:500, hiring_source:'linkedin_scrape', hiring_confidence:0.72,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'dayforce inc', display_name:'Dayforce Inc.', ticker:'DAY', exchange:'NYSE',
    industry:'Human Capital Management / Payroll / Workforce Management / Talent Acquisition SaaS', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:9000, workforce_source:'annual_report', workforce_confidence:0.88,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.80,
    hiring_velocity_score:0.2, total_open_roles:350, hiring_source:'linkedin_scrape', hiring_confidence:0.72,
    enrichment_version:'gt18-v2026.1' },

  // ── PropTech (Yahoo-listed) ────────────────────────────────────────────────
  { canonical_name:'zillow group inc', display_name:'Zillow Group Inc.', ticker:'Z', exchange:'NASDAQ',
    industry:'Real Estate Marketplace / Home Search / Mortgage / PropTech / Trulia / StreetEasy', sector:'Technology',
    ...
    hiring_velocity_score:-0.3, total_open_roles:250, hiring_source:'linkedin_scrape', hiring_confidence:0.72,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'costar group inc', display_name:'CoStar Group Inc.', ticker:'CSGP', exchange:'NASDAQ',
    industry:'Commercial Real Estate Data / Apartments.com / Homes.com / LoopNet / CRE Analytics', sector:'Technology',
    ...
    hiring_velocity_score:0.5, total_open_roles:400, hiring_source:'linkedin_scrape', hiring_confidence:0.75,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'redfin corporation', display_name:'Redfin Corporation', ticker:'RDFN', exchange:'NASDAQ',
    industry:'Real Estate Brokerage / Home Buying / Mortgage / PropTech / Digital Real Estate', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:4000, workforce_source:'annual_report', workforce_confidence:0.85,
    recent_layoff_count:4, layoff_source:'news_rss_scrape', layoff_confidence:0.90,
    hiring_velocity_score:-0.8, total_open_roles:100, hiring_source:'linkedin_scrape', hiring_confidence:0.70,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'compass inc', display_name:'Compass Inc.', ticker:'COMP', exchange:'NYSE',
    industry:'Technology-Powered Real Estate / Residential Brokerage / Agent Platform / PropTech', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:5500, workforce_source:'annual_report', workforce_confidence:0.85,
  ...
  { canonical_name:'opendoor technologies inc', display_name:'Opendoor Technologies Inc.', ticker:'OPEN', exchange:'NASDAQ',
    industry:'iBuying / Real Estate Marketplace / Instant Home Offers / PropTech', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:2600, workforce_source:'annual_report', workforce_confidence:0.85,
    recent_layoff_count:4, layoff_source:'news_rss_scrape', layoff_confidence:0.90,
    hiring_velocity_score:-1.2, total_open_roles:80, hiring_source:'linkedin_scrape', hiring_confidence:0.70,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'blend labs inc', display_name:'Blend Labs Inc.', ticker:'BLND', exchange:'NYSE',
    industry:'Digital Mortgage / Lending Platform / Banking Software / Loan Origination SaaS', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:600, workforce_source:'annual_report', workforce_confidence:0.85,
    recent_layoff_count:4, layoff_source:'news_rss_scrape', layoff_confidence:0.90,
    hiring_velocity_score:-1.5, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    enrichment_version:'gt18-v2026.1' },

  { canonical_name:'smartrent inc', display_name:'SmartRent Inc.', ticker:'SMRT', exchange:'NYSE',
    industry:'Smart Home Automation / Multifamily PropTech / IoT Property Management', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:500, workforce_source:'annual_report', workforce_confidence:0.85,
    recent_layoff_count:2, layoff_source:'news_rss_scrape', layoff_confidence:0.80,
    hiring_velocity_score:-0.5, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    enrichment_version:'gt18-v2026.1' },

  // ── Private HRTech / WorkTech / LegalTech ─────────────────────────────────
  { canonical_name:'rippling inc', display_name:'Rippling Inc.', ticker:null, exchange:null,
    industry:'HR & IT Management / Payroll / Benefits / Device Management / Workforce Platform', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:3500, workforce_source:'news_rss_scrape', workforce_confidence:0.82,
    market_cap_usd:13500000000, pe_ratio:null, revenue_ttm_usd:350000000,
    ...
    hiring_velocity_score:1.5, total_open_roles:300, hiring_source:'linkedin_scrape', hiring_confidence:0.75,
    data_quality_tier:'seed', enrichment_version:'gt18-v2026.1' },

  { canonical_name:'lattice hq inc', display_name:'Lattice HQ Inc.', ticker:null, exchange:null,
    industry:'Performance Management / OKRs / Employee Engagement / People Analytics / HR SaaS', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1400, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:3000000000, pe_ratio:null, revenue_ttm_usd:130000000,
    financials_source:'news_rss_scrape', financials_confidence:0.60,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.78,
    hiring_velocity_score:0.2, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    data_quality_tier:'seed', enrichment_version:'gt18-v2026.1' },

  { canonical_name:'culture amp pty ltd', display_name:'Culture Amp Pty Ltd', ticker:null, exchange:null,
    industry:'Employee Experience Platform / Engagement Surveys / Performance / DEI Analytics', sector:'Technology',
    is_public:false, country_code:'AU', workforce_count:700, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
  ...
  { canonical_name:'personio se & co kgaa', display_name:'Personio SE & Co. KGaA', ticker:null, exchange:null,
    industry:'HR Software / Payroll / Recruiting / SMB HR Platform / European HRTech', sector:'Technology',
    is_public:false, country_code:'DE', workforce_count:2000, workforce_source:'news_rss_scrape', workforce_confidence:0.80,
    market_cap_usd:8500000000, pe_ratio:null, revenue_ttm_usd:200000000,
  ...
  { canonical_name:'hibob ltd', display_name:'HiBob Ltd', ticker:null, exchange:null,
    industry:'HR Platform / People Management / Bob HRIS / Mid-Market HR Software / Israeli HRTech', sector:'Technology',
    is_public:false, country_code:'IL', workforce_count:1200, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:2450000000, pe_ratio:null, revenue_ttm_usd:150000000,
    financials_source:'news_rss_scrape', financials_confidence:0.60,
    recent_layoff_count:0, layoff_source:'news_rss_scrape', layoff_confidence:0.72,
    hiring_velocity_score:0.5, total_open_roles:70, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    data_quality_tier:'seed', enrichment_version:'gt18-v2026.1' },

  { canonical_name:'themis solutions inc', display_name:'Clio (Themis Solutions Inc.)', ticker:null, exchange:null,
    industry:'Legal Practice Management / Law Firm Software / Legal CRM / LegalTech SaaS', sector:'Technology',
    is_public:false, country_code:'CA', workforce_count:1700, workforce_source:'news_rss_scrape', workforce_confidence:0.80,
    market_cap_usd:3000000000, pe_ratio:null, revenue_ttm_usd:180000000,
    financials_source:'news_rss_scrape', financials_confidence:0.62,
    recent_layoff_count:0, layoff_source:'news_rss_scrape', layoff_confidence:0.72,
    hiring_velocity_score:0.6, total_open_roles:100, hiring_source:'linkedin_scrape', hiring_confidence:0.70,
    data_quality_tier:'seed', enrichment_version:'gt18-v2026.1' },

  { canonical_name:'vts inc', display_name:'VTS Inc.', ticker:null, exchange:null,
    industry:'Commercial Real Estate Technology / Leasing Platform / Tenant Experience / CRE SaaS', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1100, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:2500000000, pe_ratio:null, revenue_ttm_usd:80000000,
    financials_source:'news_rss_scrape', financials_confidence:0.58,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.75,
...
async function main() {
  console.log('\n✓ Connected — GT18: PropTech, HRTech & WorkTech (2026)\n');
  await initYahoo();
  ...
  console.log(`\n── GT18 complete: ${inserted} inserted, ${updated} updated | PE: ${withPE}/${companies.length} | Rev: ${withRev}/${companies.length}`);
  await pool.end();
}
