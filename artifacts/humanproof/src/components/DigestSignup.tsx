        ...
        <>
          <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
            <input
              ...
              style={{ flex: 1, background: 'var(--alpha-bg-06)', border: `1px solid ${status === 'error' ? 'var(--red)' : 'var(--border)'}`, borderRadius: 8, padding: '9px 12px', color: 'var(--text)', fontFamily: 'var(--body)', fontSize: '0.85rem' }}
            />
            <button
              onClick={onSubscribe}
