...
const HUMAN_TITLE_ALIAS_MAP: Record<string, { canonicalKey: string; displayRole: string }> = {
  ...
  // ── AI-Native & Human-AI Orchestration Roles (v50.0) ──────────────────────
  "vibe coder": { canonicalKey: "em_vibe_coder", displayRole: "Vibe Coding Developer" },
  "vibe coding developer": { canonicalKey: "em_vibe_coder", displayRole: "Vibe Coding Developer" },
  "vibe coding engineer": { canonicalKey: "em_vibe_coder", displayRole: "Vibe Coding Developer" },
  "ai coder": { canonicalKey: "em_vibe_coder", displayRole: "Vibe Coding Developer" },
  "agent operations manager": { canonicalKey: "em_agent_ops_mgr", displayRole: "Agent Operations Manager" },
  "agent ops manager": { canonicalKey: "em_agent_ops_mgr", displayRole: "Agent Operations Manager" },
  "agentic operations lead": { canonicalKey: "em_agent_ops_mgr", displayRole: "Agent Operations Manager" },
  "ai agent manager": { canonicalKey: "em_agent_ops_mgr", displayRole: "Agent Operations Manager" },
  "ai workflow architect": { canonicalKey: "em_ai_workflow_arch", displayRole: "AI Workflow Architect" },
  "ai process architect": { canonicalKey: "em_ai_workflow_arch", displayRole: "AI Workflow Architect" },
  "ai solutions architect": { canonicalKey: "em_ai_workflow_arch", displayRole: "AI Workflow Architect" },
  "ai workforce strategist": { canonicalKey: "em_ai_workforce_strategist", displayRole: "AI Workforce Strategist" },
  "ai workforce consultant": { canonicalKey: "em_ai_workforce_strategist", displayRole: "AI Workforce Strategist" },
  "future of work consultant": { canonicalKey: "em_ai_workforce_strategist", displayRole: "AI Workforce Strategist" },
  "ai governance lead": { canonicalKey: "em_ai_governance_lead", displayRole: "AI Governance Lead" },
  "ai governance manager": { canonicalKey: "em_ai_governance_lead", displayRole: "AI Governance Lead" },
  "responsible ai lead": { canonicalKey: "em_ai_governance_lead", displayRole: "AI Governance Lead" },
  "ai compliance manager": { canonicalKey: "em_ai_governance_lead", displayRole: "AI Governance Lead" },
  "autonomous agent supervisor": { canonicalKey: "em_autonomous_agent_supervisor", displayRole: "Autonomous Agent Supervisor" },
  "ai agent supervisor": { canonicalKey: "em_autonomous_agent_supervisor", displayRole: "Autonomous Agent Supervisor" },
  "ai operations supervisor": { canonicalKey: "em_autonomous_agent_supervisor", displayRole: "Autonomous Agent Supervisor" },
  "human ai collaboration designer": { canonicalKey: "em_human_ai_collab_designer", displayRole: "Human-AI Collaboration Designer" },
  "human ai designer": { canonicalKey: "em_human_ai_collab_designer", displayRole: "Human-AI Collaboration Designer" },
  "ai ux designer": { canonicalKey: "em_human_ai_collab_designer", displayRole: "Human-AI Collaboration Designer" },
  "synthetic data engineer": { canonicalKey: "em_synthetic_data_eng", displayRole: "Synthetic Data Engineer" },
  "synthetic data specialist": { canonicalKey: "em_synthetic_data_eng", displayRole: "Synthetic Data Engineer" },
  "ai data engineer": { canonicalKey: "em_synthetic_data_eng", displayRole: "Synthetic Data Engineer" },
  "ai red teamer": { canonicalKey: "em_ai_red_teamer", displayRole: "AI Red Teamer" },
  "ai red team researcher": { canonicalKey: "em_ai_red_teamer", displayRole: "AI Red Teamer" },
  "adversarial ml researcher": { canonicalKey: "em_ai_red_teamer", displayRole: "AI Red Teamer" },
  "robotics ai trainer": { canonicalKey: "em_robotics_ai_trainer", displayRole: "Robotics AI Trainer" },
  "robot trainer": { canonicalKey: "em_robotics_ai_trainer", displayRole: "Robotics AI Trainer" },
  "spatial computing developer": { canonicalKey: "em_spatial_computing_dev", displayRole: "Spatial Computing Developer" },
  "xr developer": { canonicalKey: "em_spatial_computing_dev", displayRole: "Spatial Computing Developer" },
  "ar developer": { canonicalKey: "em_spatial_computing_dev", displayRole: "Spatial Computing Developer" },
  "vr developer": { canonicalKey: "em_spatial_computing_dev", displayRole: "Spatial Computing Developer" },
  "mixed reality developer": { canonicalKey: "em_spatial_computing_dev", displayRole: "Spatial Computing Developer" },
  "climate ai analyst": { canonicalKey: "em_climate_ai_analyst", displayRole: "Climate AI Analyst" },
  "carbon intelligence analyst": { canonicalKey: "em_climate_ai_analyst", displayRole: "Climate AI Analyst" },
  "climate tech analyst": { canonicalKey: "em_climate_ai_analyst", displayRole: "Climate AI Analyst" },
  "digital human designer": { canonicalKey: "em_digital_human_designer", displayRole: "Digital Human Designer" },
  "avatar systems designer": { canonicalKey: "em_digital_human_designer", displayRole: "Digital Human Designer" },
  "agentic systems designer": { canonicalKey: "em_agentic_sys_designer", displayRole: "Agentic Systems Designer" },
  "multi agent architect": { canonicalKey: "em_agentic_sys_designer", displayRole: "Agentic Systems Designer" },
  "ai systems architect": { canonicalKey: "em_agentic_sys_designer", displayRole: "Agentic Systems Designer" },
  "ai transformation lead": { canonicalKey: "em_ai_transformation_lead", displayRole: "AI Transformation Lead" },
  "ai change manager": { canonicalKey: "em_ai_transformation_lead", displayRole: "AI Transformation Lead" },
  "chief ai officer": { canonicalKey: "em_ai_transformation_lead", displayRole: "AI Transformation Lead" },
  "caio": { canonicalKey: "em_ai_transformation_lead", displayRole: "AI Transformation Lead" },
};
