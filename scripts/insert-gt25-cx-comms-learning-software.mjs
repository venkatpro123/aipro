// GT25: CX Software, Communication APIs & Learning Platforms (2026)
import pg from 'pg';
const { Pool } = pg;
...
async function upsertCompany(c) {
  ...
  const vals = [
    ...
    c.data_quality_tier??(c.is_public?'verified':'seed'), c.enrichment_version??'gt25-v2026.1', now
  ];
...
const companies = [
  ...
  { canonical_name:'five9 inc', display_name:'Five9 Inc.', ticker:'FIVN', exchange:'NASDAQ',
    industry:'Cloud Contact Center / CCaaS / AI-Powered CX / Virtual Agent / Workforce Optimization', sector:'Technology',
    ...
    enrichment_version:'gt25-v2026.1' },

  { canonical_name:'nice systems ltd', display_name:'NICE Systems Ltd.', ticker:'NICE', exchange:'NASDAQ',
    industry:'Customer Experience / Cloud Contact Center / CXone / Workforce Management / Actimize', sector:'Technology',
    is_public:true, country_code:'IL', workforce_count:8300, workforce_source:'annual_report', workforce_confidence:0.90,
  ...
  { canonical_name:'8x8 inc', display_name:'8x8 Inc.', ticker:'EGHT', exchange:'NASDAQ',
    industry:'Unified Communications / CCaaS / CPaaS / Cloud PBX / Contact Center as a Service', sector:'Technology',
    ...
    hiring_velocity_score:-1.0, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    enrichment_version:'gt25-v2026.1' },

  { canonical_name:'bandwidth inc', display_name:'Bandwidth Inc.', ticker:'BAND', exchange:'NASDAQ',
    industry:'Cloud Communications / CPaaS / Voice API / 911 Routing / Enterprise Communications', sector:'Technology',
  ...
  { canonical_name:'liveperson inc', display_name:'LivePerson Inc.', ticker:'LPSN', exchange:'NASDAQ',
    industry:'Conversational AI / Digital Customer Engagement / Messaging / AI-Powered CX Platform', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:900, workforce_source:'annual_report', workforce_confidence:0.85,
    recent_layoff_count:4, layoff_source:'news_rss_scrape', layoff_confidence:0.90,
    hiring_velocity_score:-1.5, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    enrichment_version:'gt25-v2026.1' },

  { canonical_name:'ttec holdings inc', display_name:'TTEC Holdings Inc.', ticker:'TTEC', exchange:'NASDAQ',
    industry:'Customer Experience / BPO / CX Technology / AI-Powered CX / Digital Transformation', sector:'Technology',
    is_public:true, country_code:'US', workforce_count:51000, workforce_source:'annual_report', workforce_confidence:0.88,
  ...
  { canonical_name:'shutterstock inc', display_name:'Shutterstock Inc.', ticker:'SSTK', exchange:'NYSE',
    industry:'Stock Photography / Video / Music / AI Image Generation / Creative Content Platform', sector:'Technology',
    ...
    hiring_velocity_score:-0.5, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    enrichment_version:'gt25-v2026.1' },

  { canonical_name:'healthstream inc', display_name:'HealthStream Inc.', ticker:'HSTM', exchange:'NASDAQ',
    industry:'Healthcare Learning / Clinical Development / Workforce Solutions / Credentialing', sector:'Technology',
    ...
    hiring_velocity_score:0.3, total_open_roles:40, hiring_source:'linkedin_scrape', hiring_confidence:0.68,
    enrichment_version:'gt25-v2026.1' },

  { canonical_name:'sprinklr inc', display_name:'Sprinklr Inc.', ticker:'CXM', exchange:'NYSE',
    industry:'Unified Customer Experience Management / Social Media / CX Marketing / AI Enterprise', sector:'Technology',
  ...
  // ── Private CX / comms / learning companies ────────────────────────────────
  { canonical_name:'genesys telecommunications laboratories inc', display_name:'Genesys Telecommunications Laboratories Inc.', ticker:null, exchange:null,
    industry:'Cloud Contact Center / CCaaS / Genesys Cloud / AI Customer Experience / CX Platform', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:6000, workforce_source:'news_rss_scrape', workforce_confidence:0.82,
    market_cap_usd:21000000000, pe_ratio:null, revenue_ttm_usd:2100000000,
    ...
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'talkdesk inc', display_name:'Talkdesk Inc.', ticker:null, exchange:null,
    industry:'Cloud Contact Center / AI-Powered CX / CCaaS / Workforce Management / Automation', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1500, workforce_source:'news_rss_scrape', workforce_confidence:0.80,
    market_cap_usd:10000000000, pe_ratio:null, revenue_ttm_usd:300000000,
  ...
  { canonical_name:'medallia inc', display_name:'Medallia Inc.', ticker:null, exchange:null,
    industry:'Customer Experience / Employee Experience / Feedback Management / Signal Analytics', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:2800, workforce_source:'news_rss_scrape', workforce_confidence:0.82,
    market_cap_usd:2400000000, pe_ratio:null, revenue_ttm_usd:1000000000,
    financials_source:'annual_report', financials_confidence:0.75,
    recent_layoff_count:2, layoff_source:'news_rss_scrape', layoff_confidence:0.80,
    hiring_velocity_score:-0.5, total_open_roles:80, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'zendesk inc', display_name:'Zendesk Inc.', ticker:null, exchange:null,
    industry:'Customer Service Software / Ticketing / Help Desk / CRM / AI-Powered Support Platform', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:6000, workforce_source:'news_rss_scrape', workforce_confidence:0.82,
    market_cap_usd:10200000000, pe_ratio:null, revenue_ttm_usd:2250000000,
  ...
  { canonical_name:'dialpad inc', display_name:'Dialpad Inc.', ticker:null, exchange:null,
    industry:'AI-Powered Business Communications / UCaaS / Contact Center / Voice Transcription', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1200, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:2200000000, pe_ratio:null, revenue_ttm_usd:250000000,
    financials_source:'news_rss_scrape', financials_confidence:0.62,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.75,
    hiring_velocity_score:0.2, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'messagebird bv', display_name:'MessageBird BV', ticker:null, exchange:null,
    industry:'Omnichannel Communications / CPaaS / SMS Email WhatsApp API / Customer Engagement', sector:'Technology',
    is_public:false, country_code:'NL', workforce_count:600, workforce_source:'news_rss_scrape', workforce_confidence:0.75,
    ...
    recent_layoff_count:3, layoff_source:'news_rss_scrape', layoff_confidence:0.85,
    hiring_velocity_score:-0.8, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.62,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'contentful gmbh', display_name:'Contentful GmbH', ticker:null, exchange:null,
    industry:'Headless CMS / Content Infrastructure / Composable Architecture / Digital Experience', sector:'Technology',
    is_public:false, country_code:'DE', workforce_count:800, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:3000000000, pe_ratio:null, revenue_ttm_usd:150000000,
    financials_source:'news_rss_scrape', financials_confidence:0.60,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.75,
    hiring_velocity_score:0.1, total_open_roles:40, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'seismic software inc', display_name:'Seismic Software Inc.', ticker:null, exchange:null,
    industry:'Sales Enablement / Revenue Enablement / Content Automation / Buyer Engagement', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1400, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:3000000000, pe_ratio:null, revenue_ttm_usd:250000000,
    financials_source:'news_rss_scrape', financials_confidence:0.62,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.75,
    hiring_velocity_score:0.2, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'highspot inc', display_name:'Highspot Inc.', ticker:null, exchange:null,
    industry:'Sales Enablement / Revenue Enablement / AI Sales Coaching / Content & Training', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:1000, workforce_source:'news_rss_scrape', workforce_confidence:0.78,
    market_cap_usd:3500000000, pe_ratio:null, revenue_ttm_usd:200000000,
    financials_source:'news_rss_scrape', financials_confidence:0.62,
    recent_layoff_count:1, layoff_source:'news_rss_scrape', layoff_confidence:0.75,
    hiring_velocity_score:0.3, total_open_roles:60, hiring_source:'linkedin_scrape', hiring_confidence:0.65,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'usertesting inc', display_name:'UserTesting Inc.', ticker:null, exchange:null,
    industry:'User Research / UX Testing / Customer Insights / Unmoderated Testing / Video Insights', sector:'Technology',
    is_public:false, country_code:'US', workforce_count:900, workforce_source:'news_rss_scrape', workforce_confidence:0.75,
    market_cap_usd:1300000000, pe_ratio:null, revenue_ttm_usd:170000000,
    financials_source:'news_rss_scrape', financials_confidence:0.60,
    recent_layoff_count:2, layoff_source:'news_rss_scrape', layoff_confidence:0.78,
    hiring_velocity_score:-0.3, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.62,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },

  { canonical_name:'khoros llc', display_name:'Khoros LLC', ticker:null, exchange:null,
    industry:'Social Media Management / Community Platform / Customer Care / Digital Marketing', sector:'Technology',
    ...
    hiring_velocity_score:-0.2, total_open_roles:30, hiring_source:'linkedin_scrape', hiring_confidence:0.60,
    data_quality_tier:'seed', enrichment_version:'gt25-v2026.1' },
];

async function main() {
  console.log('\n✓ Connected — GT25: CX Software, Communication APIs & Learning Platforms (2026)\n');
  await initYahoo();
  ...
  console.log(`\n── GT25 complete: ${inserted} inserted, ${updated} updated | PE: ${withPE}/${companies.length} | Rev: ${withRev}/${companies.length}`);
  await pool.end();
}
