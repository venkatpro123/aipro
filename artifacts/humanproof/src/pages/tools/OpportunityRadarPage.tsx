// OpportunityRadarPage.tsx — Tool 9: Opportunity Radar
import { useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { ArrowLeft } from 'lucide-react';
import { useAuth } from '../../context/AuthContext';
import { OpportunityRadar } from '../../components/Tools/OpportunityRadar/OpportunityRadar';
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.5)', margin: 0 }}>
            Detect hiring signals, build your target company list, and get alerted when the market moves in your favor.
          </p>
        </div>
