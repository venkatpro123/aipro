...
const INCOME_BRIDGE_BY_FAMILY: Partial<Record<RoleFamily, IncomeBridgeOption[]>> = {
  ...
  product: [
    {
      type: 'freelance',
      title: 'Fractional Product Advisor / Part-Time CPO',
      description: 'Serve 1–2 early-stage startups as a fractional PM or product advisor on a retainer — set roadmap, prioritise backlog, mentor junior PMs',
      estimatedMonthlyIncome: '₹80,000–₹2,50,000 / $2,500–$8,000',
      timeToFirstRevenue: '2–4 weeks',
      hoursPerWeek: 16,
      skillOverlap: 'Roadmap, discovery, and stakeholder management transfer directly to startups with underresourced product functions',
      platforms: ['Toptal', 'Expert360', 'Lenny\'s Slack (#jobs channel)', 'LinkedIn outbound to founders'],
      riskToMainSearch: 'low',
    },
    {
      type: 'teaching',
      title: 'PM Interview Coach / Bootcamp Instructor',
      description: 'Coach candidates preparing for PM interviews — product sense frameworks, estimation, SQL, case studies — via individual sessions or cohorts',
      estimatedMonthlyIncome: '₹40,000–₹1,20,000 / $1,500–$4,500',
      timeToFirstRevenue: '1–2 weeks',
      hoursPerWeek: 8,
      skillOverlap: 'Packaging your PM knowledge as curriculum deepens your own frameworks and builds credibility',
      platforms: ['PM School', 'Exponent', 'Peerlist', 'LinkedIn', 'Teachable / Gumroad'],
      riskToMainSearch: 'low',
    },
    {
      type: 'contract',
      title: 'Contract Product Discovery Sprint',
      description: 'Help a company run a defined 4–8 week discovery or 0→1 product sprint — defined scope, fixed fee, clear deliverables',
      estimatedMonthlyIncome: '₹1,20,000–₹4,00,000 / $3,000–$12,000',
      timeToFirstRevenue: '3–5 weeks',
      hoursPerWeek: 20,
      skillOverlap: 'User research, opportunity mapping, and PRD writing are well-compensated on a project basis',
      platforms: ['Toptal', 'Gun.io', 'YC Work at a Startup', 'direct founder outreach'],
      riskToMainSearch: 'medium',
    },
  ],
  ...
  design: [
    {
      ...
      description: 'Take on 1–2 product design contracts per month — end-to-end flows, design systems, or DesignOps for startups or scale-ups',
      estimatedMonthlyIncome: '₹60,000–₹2,00,000 / $2,000–$7,000',
      timeToFirstRevenue: '1–2 weeks',
      hoursPerWeek: 20,
      skillOverlap: 'Full design skillset maps directly; rate premium for systems-level or 0→1 product experience',
      platforms: ['Toptal Design', 'DesignHill', 'Contra', 'Dribbble Jobs', 'LinkedIn outbound'],
      riskToMainSearch: 'low',
    },
    {
      type: 'teaching',
      title: 'Design Mentor / Figma Instructor',
      description: 'Run mentorship sessions or cohort workshops: portfolio reviews, Figma advanced features, case-study prep for FAANG design interviews',
      estimatedMonthlyIncome: '₹30,000–₹90,000 / $1,000–$3,000',
      timeToFirstRevenue: '1 week',
      hoursPerWeek: 8,
      skillOverlap: 'Teaching user research, information architecture, and visual craft builds your own depth',
      platforms: ['ADPList', 'Maven', 'Peerlist', 'Teachable', 'Skillshare'],
      riskToMainSearch: 'low',
    },
    {
      type: 'contract',
      title: 'Design Sprint / Brand Identity Sprint',
      description: 'Run a fixed 2–4 week design sprint, brand refresh, or design-system audit for a company — scoped deliverables, clear fee',
      estimatedMonthlyIncome: '₹1,00,000–₹3,00,000 / $2,500–$10,000',
      timeToFirstRevenue: '2–4 weeks',
      hoursPerWeek: 25,
      skillOverlap: 'Structured problem framing, rapid prototyping, and stakeholder presentations are premium-priced as fixed-scope contracts',
      platforms: ['Toptal', 'Contra', 'YC Work at a Startup', 'direct outreach via Dribbble/Behance'],
      riskToMainSearch: 'medium',
    },
  ],
  ...
  customer_success: [
    {
      ...
      description: 'Manage onboarding, retention, and expansion for 2–3 early-stage SaaS companies part-time — prevent churn, drive upsells on retainer',
      estimatedMonthlyIncome: '₹50,000–₹1,50,000 / $1,800–$5,500',
      timeToFirstRevenue: '2–3 weeks',
      hoursPerWeek: 15,
      skillOverlap: 'QBR delivery, NPS analysis, and renewal negotiation are immediately deployable',
      platforms: ['Toptal', 'Catalant', 'LinkedIn outbound to SaaS founders', 'CSM-specific Slack communities'],
      riskToMainSearch: 'low',
    },
    {
      type: 'teaching',
      title: 'CS Onboarding Framework Consultant',
      description: 'Productise your onboarding playbook as a consulting deliverable — audit a company\'s onboarding flow, deliver recommendations and templates',
      estimatedMonthlyIncome: '₹40,000–₹1,20,000 / $1,500–$4,000',
      timeToFirstRevenue: '2–3 weeks',
      hoursPerWeek: 10,
      skillOverlap: 'Success plans, health scoring, and churn-risk frameworks are valued by companies without a formal CS function',
      platforms: ['Upwork', 'Freelancer', 'LinkedIn', 'CustomerSuccessCollective Slack'],
      riskToMainSearch: 'low',
    },
    {
      type: 'gig',
      title: 'SaaS Tool Implementation Support',
      description: 'Provide implementation and admin support for CRM / CS tools (Gainsight, Salesforce, ChurnZero) — many companies need short-term setup help',
      estimatedMonthlyIncome: '₹35,000–₹1,00,000 / $1,200–$3,500',
      timeToFirstRevenue: '1–2 weeks',
      hoursPerWeek: 10,
      skillOverlap: 'Tool proficiency from your CSM role becomes a billable implementation skill',
      platforms: ['Upwork', 'Fiverr Pro', 'Salesforce AppExchange partner network'],
      riskToMainSearch: 'low',
    },
  ],
  ...
  manufacturing: [
    {
      type: 'consulting',
      title: 'Process Improvement / Lean Consultant',
      description: 'Offer Lean / Six Sigma / TPM consulting to SMB manufacturers on a day-rate basis — 5S audits, OEE improvement, downtime reduction',
      estimatedMonthlyIncome: '₹60,000–₹2,00,000 / $1,500–$5,000',
      timeToFirstRevenue: '3–5 weeks',
      hoursPerWeek: 15,
      skillOverlap: 'Lean/Six Sigma certification + shop-floor experience are directly deployable at SMBs that lack in-house expertise',
      platforms: ['LinkedIn outbound to plant managers', 'CII (India)', 'SME local chapters', 'Indeed / Naukri contract roles'],
      riskToMainSearch: 'low',
    },
    {
      type: 'contract',
      title: 'Temporary Plant / Production Supervisor',
      description: 'Take a 2–3 month contract or interim plant/production supervisor role to maintain income and keep skills current while job searching',
      estimatedMonthlyIncome: '₹40,000–₹1,20,000 / $2,000–$5,000',
      timeToFirstRevenue: '3–6 weeks',
      hoursPerWeek: 40,
      skillOverlap: 'Direct equipment/process experience and regulatory knowledge are the primary currency',
      platforms: ['TeamLease', 'Quess Corp', 'Adecco', 'Indeed contract listings', 'Naukri'],
      riskToMainSearch: 'medium',
    },
    {
      type: 'teaching',
      title: 'Technical / Vocational Trainer',
      description: 'Teach industrial process skills, safety, or maintenance to apprentices or junior workers via ITI partnerships or corporate L&D contracts',
      estimatedMonthlyIncome: '₹25,000–₹70,000 / $800–$2,000',
      timeToFirstRevenue: '2–3 weeks',
      hoursPerWeek: 12,
      skillOverlap: 'Domain authority translates directly to teaching credibility; also signals reliability to future employers',
      platforms: ['NSDC / PMKVY empanelment', 'Local ITI partnerships', 'LinkedIn Learning instructor', 'Corporate L&D outreach'],
      riskToMainSearch: 'low',
    },
  ],
};
