    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold" style={{ color: 'var(--alpha-text-85)' }}>Compensation Risk</span>
        </div>
        <span
      ...
      {/* Cascade stage bar */}
      <div className="mb-3">
        <div className="text-[10px] font-medium mb-1.5" style={{ color: 'var(--alpha-text-45)' }}>
        ...
        <div className="flex justify-between mt-1">
          <span className="text-[10px]" style={{ color: 'var(--alpha-text-35)' }}>Normal</span>
          <span className="text-[10px] font-semibold" style={{ color: colors.text }}>
            {STAGE_SHORT[compensation.cascadeStage]}
          </span>
          <span className="text-[10px]" style={{ color: 'var(--alpha-text-35)' }}>Pre-Layoff</span>
        </div>
      </div>
      ...
      {/* Stage label */}
      <p className="text-[11px] leading-relaxed mb-2.5" style={{ color: 'var(--alpha-text-55)' }}>
      ...
      <div className="rounded-lg p-2.5 mb-2.5" style={{ background: 'var(--alpha-bg-04)' }}>
        ...
        {medianLabel && (
          <div className="text-[10px]" style={{ color: 'var(--alpha-text-45)' }}>
          ...
          <div className="space-y-1">
            {compensation.nextCascadeSignals.slice(0, 2).map((sig, i) => (
              <div key={i} className="flex items-start gap-1.5">
                <TrendingDown className="w-3 h-3 mt-0.5 flex-shrink-0" style={{ color: 'var(--alpha-text-30)' }} />
